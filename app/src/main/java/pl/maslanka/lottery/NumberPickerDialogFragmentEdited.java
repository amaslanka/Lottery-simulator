...
import com.codetroopers.betterpickers.numberpicker.*;
...
/**
 * Created by Artur on 29.10.2016.
 */

public class NumberPickerDialogFragmentEdited extends com.codetroopers.betterpickers.numberpicker.NumberPickerDialogFragment {
    ...
    private Vector<NumberPickerDialogFragment.NumberPickerDialogHandlerV2> mNumberPickerDialogHandlersV2 = new Vector<NumberPickerDialogFragment.NumberPickerDialogHandlerV2>();
    ...
    NumberPickerDialogFragment to NumberPickerDialogFragmentEdited
    !!!!!!!!!!!!!!!!!!!!!!!!!!!
    </Edited code>
    !!!!!!!!!!!!!!!!!!!!!!!!!!!
    */
    public static NumberPickerDialogFragmentEdited newInstance(int reference,
                                                         int themeResId,
        ...
        final NumberPickerDialogFragmentEdited frag = new NumberPickerDialogFragmentEdited();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Init defaults
        mTextColor = getResources().getColorStateList(com.codetroopers.betterpickers.R.color.dialog_text_color_holo_dark);
        mDialogBackgroundResId = com.codetroopers.betterpickers.R.drawable.dialog_full_holo_dark;

        if (mTheme != -1) {
            TypedArray a = getActivity().getApplicationContext().obtainStyledAttributes(mTheme, com.codetroopers.betterpickers.R.styleable.BetterPickersDialogFragment);

            mTextColor = a.getColorStateList(com.codetroopers.betterpickers.R.styleable.BetterPickersDialogFragment_bpTextColor);
            mDialogBackgroundResId = a.getResourceId(com.codetroopers.betterpickers.R.styleable.BetterPickersDialogFragment_bpDialogBackground, mDialogBackgroundResId);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(com.codetroopers.betterpickers.R.layout.number_picker_dialog, null);
        Button doneButton = (Button) view.findViewById(com.codetroopers.betterpickers.R.id.done_button);
        Button cancelButton = (Button) view.findViewById(com.codetroopers.betterpickers.R.id.cancel_button);

        cancelButton.setTextColor(mTextColor);
        cancelButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_background_light));
        ...
        doneButton.setBackgroundDrawable(getResources().getDrawable(R.drawable.button_background_light));
        doneButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BigDecimal number = mPicker.getEnteredNumber();
                if (mMinNumber != null && mMaxNumber != null && (isSmaller(number) || isBigger(number))) {
                    String errorText = getString(com.codetroopers.betterpickers.R.string.min_max_error, mMinNumber, mMaxNumber);
                    mPicker.getErrorView().setText(errorText);
                    mPicker.getErrorView().show();
                    return;
                } else if (mMinNumber != null && isSmaller(number)) {
                    String errorText = getString(com.codetroopers.betterpickers.R.string.min_error, mMinNumber);
                    mPicker.getErrorView().setText(errorText);
                    mPicker.getErrorView().show();
                    return;
                } else if (mMaxNumber != null && isBigger(number)) {
                    String errorText = getString(com.codetroopers.betterpickers.R.string.max_error, mMaxNumber);
                    mPicker.getErrorView().setText(errorText);
                    mPicker.getErrorView().show();
                    return;
                }
                for (NumberPickerDialogFragment.NumberPickerDialogHandlerV2 handler : mNumberPickerDialogHandlersV2) {
                    handler.onDialogNumberSet(mReference, mPicker.getNumber(), mPicker.getDecimal(), mPicker.getIsNegative(), number);
                }
                final Activity activity = getActivity();
                final Fragment fragment = getTargetFragment();
                if (activity instanceof NumberPickerDialogFragment.NumberPickerDialogHandlerV2) {
                    final NumberPickerDialogFragment.NumberPickerDialogHandlerV2 act = (NumberPickerDialogFragment.NumberPickerDialogHandlerV2) activity;
                    act.onDialogNumberSet(mReference, mPicker.getNumber(), mPicker.getDecimal(), mPicker.getIsNegative(), number);
                } else if (fragment instanceof NumberPickerDialogFragment.NumberPickerDialogHandlerV2) {
                    final NumberPickerDialogFragment.NumberPickerDialogHandlerV2 frag = (NumberPickerDialogFragment.NumberPickerDialogHandlerV2) fragment;
                ...
                store "number" in shared preferences and then dismiss dialog
                !!!!!!!!!!!!!!!!!!!!!!!!!!!
                </Edited code>
                !!!!!!!!!!!!!!!!!!!!!!!!!!!
                */

                editor.putInt(KEY_MAX_LIST_SIZE, number.intValue());
                editor.commit();
                Log.d("Number Int value", number.toString());
                Log.d("preference value", Integer.toString(preferences.getInt(KEY_BACKUP_MAX_LIST_SIZE, Logic.DEFAULT_MAX_ALL_NUMBERS_SIZE)));

                dismiss();
            }
        });

        mPicker = (NumberPicker) view.findViewById(com.codetroopers.betterpickers.R.id.number_picker);
     ...
     */
    public void setNumberPickerDialogHandlersV2(Vector<NumberPickerDialogFragment.NumberPickerDialogHandlerV2> handlers) {
