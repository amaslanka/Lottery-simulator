...
public class GameResultsUserNumbers extends AppCompatActivity {
...
//        Log.i("howMuchHits", Integer.toString(howMuchHits));
    ...
    protected void redraw() {
        ...
        //Add your numbers to Logic, run drawing and check results
        Collections.sort(yourNumbersToGet);
        MainActivity.logic.getNumbers().addAll(yourNumbersToGet);
