...
public class NumberPickerBuilderEdited extends com.codetroopers.betterpickers.numberpicker.NumberPickerBuilder {
    ...
    public NumberPickerBuilder setCurrentNumber(Integer number) {
        if (number != null) {
            if (number >= 0) {
                this.currentSignValue = com.codetroopers.betterpickers.numberpicker.NumberPicker.SIGN_POSITIVE;
            } else {
                this.currentSignValue = com.codetroopers.betterpickers.numberpicker.NumberPicker.SIGN_NEGATIVE;
                number = number * -1;
            }
    ...
    public void show() {
        ...
        <Edited code>
        !!!!!!!!!!!!!!!!!!!!!!!!!!!
        New object type changed (named "fragment")
        ...
        */
        ...
        final NumberPickerDialogFragmentEdited fragment = NumberPickerDialogFragmentEdited
